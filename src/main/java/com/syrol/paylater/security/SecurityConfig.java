...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests().antMatchers("/api/v1/test1", "/api/v1/user/validate/otp", "/api/v1/user/verify/phone_number", "/api/v1/items", "/api/v1/items/**",
    ...
    public FilterRegistrationBean<CorsFilter> corFilter() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3000","https://paylaterbo.herokuapp.com"));
